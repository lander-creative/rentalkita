      ...
      <div className="max-w-4xl mx-auto">
            ...
            return (
              ...
              >
                <button
                  ...
                  id={`faq-btn-${index}`}
                >
                  <span className={`font-headline font-bold text-base md:text-lg transition-colors ${isOpen ? 'text-primary' : 'text-on-surface'}`}>
                    {faq.question}
                  </span>
                  <span
                ...
                <div
                  ...
                  aria-hidden={!isOpen}
                >
                  <p className="px-6 pb-6 text-on-surface-variant font-body leading-relaxed">
                    {faq.answer}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-12 text-center">
          ...
          <a
            ...
            id="faq-whatsapp-cta"
            className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-[#25D366] text-white font-bold hover:bg-[#1ebe5d] transition-colors shadow-md hover:shadow-lg"
          >
